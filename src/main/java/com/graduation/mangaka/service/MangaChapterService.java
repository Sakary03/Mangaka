...
public class MangaChapterService {
    ...
    public List<MangaChapter> getChapterByBatch(int offset, int limit, String sortfield) {
        Pageable pageable = PageRequest.of(offset, limit, Sort.by(sortfield));
         return mangaChapterRepository.findAll(pageable).getContent();
    }
}
